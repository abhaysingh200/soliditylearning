...
contract lockedcrypto{
    ...
    function deposit(uint _lockedperoid) public payable { 
        ...
        lockedtime[msg.sender][latestorder] = block.timestamp + (_lockedperoid * 1 seconds);
    ...
    function withdraw(uint orderid) public payable  {
        require(usersamount[msg.sender][orderid] > 0, "In this order amount is 0");
        ...
        usersamount[msg.sender][orderid]= 0;
